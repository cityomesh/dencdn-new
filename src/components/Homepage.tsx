...
// import { FiRefreshCcw, FiSearch, FiTrash2, FiAlertCircle, FiChevronLeft, FiChevronRight, FiEdit, FiArrowLeft } from "react-icons/fi";
...
//   // Fetch rules from all servers - wrapped in useCallback
...
//               // Add the path (use origin_path first, then fallback to requestPath)
...
//   }, [servers]); // Add servers as dependency
...
//     // Update selected assignment for details modal
...
//               title={servers.length === 0 ? "Add servers first" : "Reload data from all servers"}
//             >
//               {isLoading ? (
//                 <>
...
//         {/* MAIN TABLE SECTION WITH SCROLLBAR */}
...
//                             <div className="text-sm mb-4">Click &quot;Reload Rules&quot; to fetch data from servers</div>
//                             <button 
//                               onClick={handleReload}
...
//                             {assignment.redirect.startsWith('http') 
//                               ? assignment.redirect 
//                               : `http://${assignment.redirect}`}
//                             {assignment.status === "error" && assignment.redirect.includes("Error") && (
...
//                     2. Select servers:
//                   </label>
//                   <div className="flex items-center gap-2 p-3 bg-[#1a1a1a] rounded border border-gray-700">
//                     <span className="text-white">{selectedAssignment.assignedServer}</span>
//                     <span className="text-xs text-gray-400">(origin)</span>
//                     <span className="ml-auto text-gray-400">✖ Choose servers</span>
//                   </div>
//                 </div>
                
//                 <div>
//                   <label className="block text-sm font-medium text-gray-300 mb-1">
//                     3. Stream URL example:
//                   </label>
//                   <div className="p-3 bg-[#1a1a1a] rounded border border-gray-700 text-green-300 font-mono">
//                     {editFormData.redirect}
//                   </div>
//                 </div>
...
//                     Priority (Optional)
//                   </label>
//                   <div className="text-xs text-gray-400 mb-1">Lower number means higher priority</div>
//                   <input
//                     type="number"
//                     defaultValue="10"
//                     className="w-24 px-4 py-2 rounded bg-[#1a1a1a] border border-gray-700 focus:outline-none focus:border-blue-500 text-white"
//                     placeholder="10"
//                     min="1"
//                   />
//                 </div>
...
const Homepage = () => {
  ...
  // ✅ FIXED: Load servers from API instead of localStorage
  useEffect(() => {
    fetchServers();
  }, []);
