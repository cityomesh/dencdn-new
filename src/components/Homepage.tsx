...
//     try {
//       // Define interface for route format
...
//       // Convert URLs to route format - with proper typing
...
// // Remove STORAGE_KEY - we don't need localStorage anymore
// // const STORAGE_KEY = 'manualRoutes';
...
//   // Remove loadSavedRoutes - we don't need localStorage anymore
//   // useEffect(() => {
//   //   loadSavedRoutes();
//   // }, []);
...
//   // Remove loadSavedRoutes function
//   // const loadSavedRoutes = () => { ... };

//   // Remove saveRoutesToStorage function
//   // const saveRoutesToStorage = (routes: RouteAssignment[]) => { ... };
...
//               assignedServer: server.ipAddress,
//               sourceServer: server.displayName,
//               source: "rules.conf", // Always "rules.conf" for server routes
//               status: "success",
//               host: route.host || '',
//               origin: route.origin || '',
//               originPath: originPath || requestPath,
...
//       if (allSuccess) {
//         // Instead of manually adding to state, reload from servers
//         await fetchRulesFromAllServers();
...
//       if (result.success) {
//         // Reload from server to get updated list
//         await fetchRulesFromAllServers();
