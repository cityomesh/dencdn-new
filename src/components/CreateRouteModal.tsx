...
//   }) => void;
//   availableServers?: { id: number; displayName: string; ipAddress: string }[];
// }
...
//   const toggleServer = (serverIp: string) => {
//     if (selectedServers.includes(serverIp)) {
//       setSelectedServers(selectedServers.filter(s => s !== serverIp));
//     } else {
//       setSelectedServers([...selectedServers, serverIp]);
//     }
//   };

//   const removeServer = (serverIpToRemove: string) => {
//     setSelectedServers(selectedServers.filter(ip => ip !== serverIpToRemove));
//   };
...
//             {/* Back to Overview Button - Better alignment */}
//             <button
...
//         {/* Body - Improved spacing and alignment */}
//         <div className="p-8 space-y-10">
          
//           {/* 1. Origin stream URLs - Improved tags styling */}
...
//             {/* Tags Input Area - Improved borders and alignment */}
...
//                 {/* Existing Tags - Better visual design */}
...
//           {/* 2. Select servers - Improved styling with bg-yellow-700 */}
//           <div className="space-y-4">
//             <div className="flex items-center gap-2">
...
//             ) : (
//               <div className="space-y-4">
//                 {/* Choose servers button with tags - Better alignment */}
...
//                   {/* Selected Server Tags - Improved visual design */}
//                   {selectedServers.map((ip) => {
//                     const server = availableServers.find(s => s.ipAddress === ip);
//                     return (
//                       <span
//                         key={ip}
...
//                       >
//                         <span className="font-medium text-xs">{server?.displayName || ip}</span>
//                         <span className="text-xs text-green-300/80 px-1.5 py-0.5 bg-green-900/30 rounded">({ip})</span>
//                         <button
//                           onClick={() => removeServer(ip)}
...
//                   {/* Choose servers button/text - Better styling */}
//                   <button
...
//                 {/* Server selection dropdown - Improved styling */}
//                 {showServerSelector && (
...
//                               <input
//                                 type="checkbox"
//                                 checked={selectedServers.includes(server.ipAddress)}
//                                 onChange={() => toggleServer(server.ipAddress)}
...
//                             </div>
//                           </div>
//                           {selectedServers.includes(server.ipAddress) && (
...
//                 {/* Selected count indicator - New addition */}
//                 {selectedServers.length > 0 && (
...
//         {/* Footer - Improved button styling */}
...
// // components/CreateRouteModal.tsx worked
// "use client";
